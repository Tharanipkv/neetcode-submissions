class Solution {
    public boolean isAnagram(String s, String t) {
        ...
        // Map<Character, Integer> collectT = new HashMap<>();
        // for(int i=0;i<sLength;i++){
        //     collectS.put(s.charAt(i), collectS.getOrDefault(s.charAt(i),0)+1);
        //     collectT.put(t.charAt(i), collectT.getOrDefault(t.charAt(i),0)+1);
        // }
        ...
        // return sCount.equals(tCount);
            ...
            // Map<Character, Integer> tCollect = new HashMap<>();
            // for(int i=0;i<s.length();i++){
            //     sCollect.put(s.charAt(i), collect.getorDefault(s.charAt(i),0)+1);
            //     tCollect.put(t.charAt(i), collect.getorDefault(t.charAt(i),0)+1);
            // }
            // return sCollect.equals(tCollect);
